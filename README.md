...
An evidence-led personal portfolio for software development, geospatial and climate work, and risk-aware systems. The site uses Next.js and keeps project claims adjacent to their evidence and limits.
...
The self-hosted Manrope and Newsreader font notices are retained under `public/media/licenses/` and verified with the other public media manifests. Project-specific media attribution remains adjacent to each case study.
